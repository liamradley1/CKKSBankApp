...
int main()
{
    try {
        ...
        http_listener balanceListener(L"http://ec2-54-197-165-211.compute-1.amazonaws.com:8081/balance");
        ...
        http_listener transferListener(L"http://ec2-54-197-165-211.compute-1.amazonaws.com:8081/transfer");
        ...
        http_listener debitListener(L"http://ec2-54-197-165-211.compute-1.amazonaws.com:8081/debits");
