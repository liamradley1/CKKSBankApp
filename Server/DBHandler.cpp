...
bool DBHandler::logAndHandleTransaction(Account* from, Account* to, seal::Ciphertext amount, seal::PublicKey public_key, seal::SEALContext context, seal::EncryptionParameters params)
{
